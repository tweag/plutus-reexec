...
We want to document the design decisions made while implementing this project according to the [proposal](../proposal.md).

Since many projects in the cardano ecosystem already use the ADR format we adopt it as well.
