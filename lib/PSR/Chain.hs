...
-- NOTE: The script context here is all that is required to re-execute the
-- script. I assume this is minimal already and has everything that is required
-- to execute the script.
--
-- We are currently saving this script context for any kind of
-- re-execution. This is minimal and we can save it in our DB.
--
