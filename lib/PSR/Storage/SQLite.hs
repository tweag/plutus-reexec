        ...
        withResource pool $ \conn -> withTransaction conn $ do
            ...
            rows <-
                queryNamed
                    ...
                    \ (block_id, transaction_hash, script_hash, name, ledger_language, major_protocol_version, datum, redeemer, script_context, cost_model_params_id) \
        ...
        withResource pool $ \conn -> withTransaction conn $ do
            let
                ...
                eventsQuery =
                    ...
                    \ LEFT JOIN execution_event e ON e.context_id = ec.context_id \
